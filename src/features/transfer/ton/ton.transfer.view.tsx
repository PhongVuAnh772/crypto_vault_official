        ...
        <>
            <ScreenWrapper
                ...
                <AppModal
                    ...
                    subTitleWithI18n={
                        LanguageKey.ton_bounceable_action_sub_title_1
                    }
                    ...
                    footerView={
                        <>
                            <AppText
                                ...
                                titleWithI18n={
                                    LanguageKey.ton_bounceable_action_sub_title_2
                                }
                                ...
                                <AppText
                                    styles={appStyles.textAlignCenter}
                                    titleWithI18n={
                                        LanguageKey.ton_bounceable_action_sub_title_3
                                    }
                            ...
                            <AppText
                                styles={appStyles.textAlignCenter}
                                titleWithI18n={
                                    LanguageKey.ton_bounceable_action_sub_title_4
                                }
                                variant={TextVariantKeys.bodyRMedium}
                                textColor={
                                    theme.colors.text_on_surface_text_high
                            ...
                            <View style={[appStyles.pV15]}>
                                <AppText
                                    titleWithI18n={
                                        LanguageKey.ton_bounceable_action_hyper_link
                                    }
                                ...
                                <View>
                                    <View
                                        ...
                                        <CoinWidgets
                                            ...
                                            action={() => {
                                                navigation.navigate(
                                                    HomeStackScreenKey.SelectToken,
                                                );
                                            }}
                                        ...
                                        <>
                                            ...
                                            {isRequireMemo ? (
                                                <View
                                                    ...
                                                    <AppText
                                                        titleWithI18n={
                                                            LanguageKey.error_require_memo
                                                        }
                                                        variant={
                                                            TextVariantKeys.bodyMSmall
                                                        }
                                                        textColor={
                                                            appColors.functional
                                                                .pending
                                                        }
                                                    />
                                                </View>

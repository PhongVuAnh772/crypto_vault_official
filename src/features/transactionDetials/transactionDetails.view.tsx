                            ...
                            {transactionData.isShowDefaults ? (
                                ...
                                <View style={[styles.detailsContainer]}>
                                    <DetailRow
                                        ...
                                        value={`${convertTitle({
                                            amount:
                                                Number(
                                                    transactionData.amountTonAttachedSmartExc,
                                                ) ?? 0,
                                        })}`}
                                        totalAmount
                                        variantValue={
                                    ...
                                    <DetailRow
                                        titleWithI18n={
                                            LanguageKey.transaction_detail_date
                                        }
                                    ...
                                    <DetailRow
                                        ...
                                        value={
                                            transactionData.isMultipleTransaction
                                                ? AppI18Next.t(
                                                      LanguageKey.common_multiple_addresses,
                                                  )
                                    ...
                                    {transactionData?.txHash && (
                                        <DetailRow
                                            titleWithI18n={
                                                LanguageKey.transaction_tx_has_title
                                            }
                                ...
                                <View style={[styles.detailsContainer]}>
                                    ...
                                    {!isTonNFTTransfer && isSendEVMNFT ? (
                                        <DetailRow
                                            titleWithI18n={
                                                LanguageKey.common_text_token_id
                                            }
                                    ...
                                    {transactionData?.estimatedGasFee ? (
                                        <DetailRow
                                            titleWithI18n={
                                                LanguageKey.nft_estimated_gas_fee
                                            }
                                            value={convertTitle({

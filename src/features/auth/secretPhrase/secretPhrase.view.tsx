...
const SecretPhrase: React.FC<RootNavigationType> = ({ navigation }) => {
  ...
  return (
    <ScreenWrapper
      ...
      backgroundImage={
        themeMode ? appImages.background1 : appImages.background1Dark
      }
      ...
      <ImageBackground style={appStyles.flex1} source={undefined}>
        <View style={[appStyles.alignItemsCenter, appStyles.flex1]}>
          ...
          <AppText
            ...
            variant={TextVariantKeys.bodyMMedium}
            styles={[appStyles.textAlignCenter, appStyles.mt15, appStyles.pH15]}
            textColor={theme.colors.label_surface_button_primary}
          />
          <View
            style={[
          ...
          >
            ...
            >
              ...
              >
                ...
                <AppText
                  titleWithI18n={LanguageKey.secret_phrase_written_title}
                  variant={TextVariantKeys.bodyMMedium}
                  styles={appStyles.textAlignCenter}
                  textColor={theme.colors.text_on_surface_text_high}
                />

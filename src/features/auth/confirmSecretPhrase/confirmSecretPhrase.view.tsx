    ...
    return (
      <View style={appStyles.mbt25}>
        ...
        <View style={styles.questionContainer2}>
          <View style={[styles.questionTitle, styles.bdr100]}>
            <AppText
              title={item.question}
  ...
  return (
    ...
    >
      <AppModal
        ...
        titleWithI18n={LanguageKey.confirm_secret_phrase_incorrect_title}
        subTitleWithI18n={LanguageKey.confirm_secret_phrase_incorrect_sub_title}
      ...
      <View style={styles.container}>
        <View style={[appStyles.mh15, appStyles.mv25]}>
          <AppText
            titleWithI18n={LanguageKey.confirm_secret_phrase_sub_title}

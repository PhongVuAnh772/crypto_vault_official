      ...
      >
        ...
        <View style={NFTDetailStyle.container}>
          <View style={NFTDetailStyle.content}>
            ...
            />
            <View style={[NFTDetailStyle.p16, NFTDetailStyle.boxContainer]}>
              ...
              <View style={NFTDetailStyle.information}>
                ...
                />
                <View
                  style={[NFTDetailStyle.alignItemsEnd, NFTDetailStyle.flexRow]}
                >
                  <TouchableOpacity onPress={handlePressURL}>
                    <AppText
                      title={walletUtils.getShortAddress(root.contractAddress)}
              ...
              <View style={NFTDetailStyle.information}>
                ...
                >
                  <AppText
                    title={NFT.detail.nftDetailAll.collection?.name || "-"}
                    variant={TextVariantKeys.bodyMMedium}
            ...
            <View
              style={[NFTDetailStyle.description, NFTDetailStyle.boxContainer]}
            >
              <AppText
              ...
              />
              <AppText
                title={NFT.detail.nftDetailAll.metadata?.description}
                variant={TextVariantKeys.bodyMMedium}
                textColor={appColors.neutral.n800}

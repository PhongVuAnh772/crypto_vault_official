    ...
    <>
      {usingWithLoading ? (
        <View style={styles.headerLoadingContainer}>
          <View style={[appStyles.flexRow, styles.indexLoadingColumn]}>
            <AppText
              titleWithI18n={"#"}
          ...
          <View style={[styles.priceLoadingColumn, appStyles.alignItemsEnd]}>
            <AppText
          ...
          <View style={[styles.changeLoadingColumn, appStyles.alignItemsEnd]}>
            <AppText
        ...
        <View style={styles.headerContainer}>
          ...
          <View style={[styles.priceHeaderColumn, appStyles.alignItemsEnd]}>
            <AppText
              titleWithI18n={LanguageKey.top_5_tokens_last_price}
              variant={TextVariantKeys.bodyMSmall}
              textColor={theme.colors.text_on_surface_text_light}
          ...
          <View style={[styles.changeHeaderColumn, appStyles.alignItemsEnd]}>
            <AppText
              titleWithI18n={LanguageKey.top_5_tokens_24h}
              variant={TextVariantKeys.bodyMSmall}
              textColor={theme.colors.text_on_surface_text_light}
      ...
      >
        ...
        <View style={[appStyles.flexRow, appStyles.alignItemsCenter]}>
          ...
          <View style={styles.ml8}>
            ...
            />
            <AppText
              title={`$${Utils.formatMarketCap(Number(item.market_cap_usd))}`}
              variant={TextVariantKeys.bodyMSmall}
              textColor={theme.colors.text_on_surface_text_light}
...
const TopTokenLoading = ({}: TopTokenLoadingProps) => {
  const theme = useAppTheme();
  const styles = useStyle(theme);
  ...
  return (
    <View style={styles.loadingContainer}>
      <FlatList
        ...
        ListHeaderComponent={<HeaderListTopTokens usingWithLoading />}
      />
    </View>
  );
};

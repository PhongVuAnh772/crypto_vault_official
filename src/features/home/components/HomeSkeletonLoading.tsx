    ...
    return newUI ? (
        <Animated.View style={[{ opacity }, appStyles.flex1, appStyles.mt15]}>
            <ViewSvg
                ...
                itemHeight={280}
                usingForLoading>
                <View style={[appStyles.fullWidth, appStyles.pH15]}>
                    <WalletInfoLoading newUI={newUI} colors={newUIColors} />
                </View>
            </ViewSvg>
            <ViewSvg
                usingForLoading
                SvgView={SvgView.viewCrypto}
                itemHeight={300}
                styleContainer={appStyles.mt10}>
                <View style={{ height: 280 }}>
                    <SkeletonLoadingList colors={newUIColors} />
                </View>
            </ViewSvg>
        </Animated.View>
    ) : (
                ...
                <View style={[appStyles.flexRow, appStyles.alignItemsCenter]}>
                    ...
                    <View style={[appStyles.pL10]}>
                        <View style={[appStyles.flexRow]}>
                            <AppSkeletonLoading
                                width={getSizePercent(12)}
                                colors={colors}
                            />
                            <View style={appStyles.ml5} />
                            <AppSkeletonLoading
                                width={getSizePercent(13)}
                                colors={colors}
                            />
                        </View>
                        <View style={appStyles.mt5} />
...
const WalletInfoLoading: React.FC<WalletInfoLoadingType> = ({
    newUI = false,
    colors,
}) => {
    const theme: AppThemeType = useAppTheme();
    ...
    return (
        <>
            ...
            <View
                ...
                <AppSkeletonLoading
                    width={getSizePercent(newUI ? 52 : 87)}
                    height={76}
                    colors={colors}
                />
                <AppSkeletonLoading
                    width={getSizePercent(newUI ? 25 : 30)}
                    height={76}
                    colors={colors}
                />
            </View>

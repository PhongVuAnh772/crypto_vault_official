                        ...
                        <View
                            ...
                            <View
                                ...
                                <View style={[appStyles.mr5]}>
                                    <AppText
                                        titleWithI18n={
                                            LanguageKey.send_lock_maximum_title
                                        }
                                        variant={TextVariantKeys.bodyMSmall}
                        ...
                        <View>
                            <AppShowView
                                ...
                                <View style={[appStyles.mt25]}>
                                    <AppText
                                        titleWithI18n={
                                            LanguageKey.common_text_lock_overview
                                        }
                                        variant={TextVariantKeys.bodyMSmall}
                                        textColor={
                                            theme.colors

    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <View style={[appStyles.pl5, styles.fire]}>
            <FireSvgIcon />
          </View>
        </View>
        <View style={[appStyles.flexRow, appStyles.mv10]}>
          <Pressable style={styles.button} onPress={navigatingToTop5Tokens}>
            <FastImage
          ...
          <Pressable style={styles.button} onPress={navigatingToTop5EVMs}>
            <FastImage
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <RenderProjectClaimList
                ...
                formatDateToDDMM={DateTimeUtils.formatDateToDDMM}
            ...
            ListFooterComponent={
              enableLoadMore ? (
                <EndReachedFooter loadMore={loadMore} theme={theme} />
              ) : null
            }
            showsVerticalScrollIndicator={false}
          />

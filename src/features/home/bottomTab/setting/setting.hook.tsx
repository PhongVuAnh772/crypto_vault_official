...
export const useSetting = ({ navigation }: RootNavigationType) => {
    ...
    const enableFaceId = async (): Promise<void> => {
        try {
            ...
            const checkFaceIdOrTouchResult =
                await faceIdOrTouch.checkFaceIdOrTouch();
            if (!pinCode) {
                Utils.showToast({
                    msg: t(LanguageKey.send_push_error_title),
                    type: AppToastType.error,
    ...
    const featureLanguages = {
        ...
        onPress: () =>
            navigation.dispatch(
                StackActions.push(HomeStackScreenKey.ChangeLanguage),
            ),
    };
    ...
    const featureChangePinCode = {
        ...
        onPress: () =>
            navigation.dispatch(
                StackActions.push(HomeStackScreenKey.ChangePincode),
            ),
    };
    ...
    const featureSwap = {
        ...
        onPress: () => {
            if (guidingSwap) {
                navigation.dispatch(
                    StackActions.push(HomeStackScreenKey.GuidingSwap),
                );
            } else {
            ...
            data: [
                {
                    ...
                    onPress: () =>
                        navigation.dispatch(
                            StackActions.push(HomeStackScreenKey.AboutUs),
                        ),
                },
                {
                    ...
                    onPress: () =>
                        navigation.dispatch(
                            StackActions.push(HomeStackScreenKey.Contact),
                        ),
                },
                {
                    ...
                    onPress: () =>
                        navigation.dispatch(
                            StackActions.push(HomeStackScreenKey.FAQ),
                        ),
                },
            ],
        },

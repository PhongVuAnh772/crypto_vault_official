            ...
            <ScreenWrapper
                ...
                <View style={[appStyles.flex1, appStyles.pB70]}>
                    ...
                    <View style={appStyles.mh25}>
                        <View style={appStyles.mt5}>
                            {!isOngoing(props?.endDate) && (
                                <WarningTransactionStatus
                                    theme={theme}
                                    text={
                                        LanguageKey.warning_expired_project_claim
                                    }
                                />
                            )}
                            {isUpComing(props?.startDate) && (
                                <WarningTransactionStatus
                                    theme={theme}
                                    text={t(
                                        LanguageKey.claim_token_message_upcoming,
                                        {
                                            startDate:
                        ...
                        <View
                            ...
                            <LoadingWrapper
                                ...
                                <AppText
                                    titleWithI18n={
                                        LanguageKey.project_details_overview_title
                                    }
                        ...
                        <View style={styles.cartWrapper}>
                            <LoadingWrapper
                                ...
                                skeletonHeight={150}>
                                <View
                                    style={styles.projectDescriptionContainer}>
                                    <ProjectDescription
                                        description={
                        ...
                        <View
                            ...
                            <LoadingWrapper
                                ...
                                <AppText
                                    titleWithI18n={
                                        LanguageKey.project_details_price_feed
                                    }
                                    variant={TextVariantKeys.labelCap}
                                    textColor={
                                        theme.colors.text_on_surface_text_light
                            ...
                            <LoadingWrapper
                                ...
                                <Pressable
                                    ...
                                    <AppText
                                        titleWithI18n={
                                            LanguageKey.claim_check_what_you_forgot
                                        }
                    ...
                    <JettonPriceChart
                        ...
                        itemGotting={
                            dataClaimable?.projectToken?.priceChartScanURL
                        }
                        _handleShowChartAsync={_handleShowChartAsync}
                    />

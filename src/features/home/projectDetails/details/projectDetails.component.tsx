                ...
                <View style={[appStyles.flexRow, appStyles.pT30]}>
                    {newUI ? (
                        <AppButtonSVG
                            ...
                            styles={styles.buttonModalNewUI}
        ...
        <View style={appStyles.flex1}>
            <View>
                <View style={[appStyles.flexRow, appStyles.alignItemsCenter]}>
                    <AppText
                        titleWithI18n={t(
                            LanguageKey.claim_token_link_ton_address,
                        )}
        ...
        <View style={appStyles.flex1}>
            <View>
                <View style={[appStyles.flexRow, appStyles.alignItemsCenter]}>
                    <AppText
                        titleWithI18n={t(
                            LanguageKey.claim_token_linked_ton_address,
                        )}
                        variant={TextVariantKeys.bodyRSmall}
                        textColor={theme.colors.text_on_surface_text_medium}
                        styles={appStyles.pR5}
                    ...
                    <View
                        ...
                        <LoadingWrapper
                            ...
                            <Pressable
                                ...
                                <AppText
                                    titleWithI18n={
                                        LanguageKey.NFT_you_own_action_add
                                    }
                                    variant={TextVariantKeys.bodyMLarge}
                                    textColor={
                                        theme.colors.text_on_surface_text_high
                    ...
                    <View style={styles.headerChart}>
                        ...
                        <View>
                            <Pressable
                                ...
                                style={styles.closeButton}></Pressable>
                            <Pressable
                                onPress={onCloseGottingModal}
                                style={styles.closeButton}></Pressable>
                        </View>
                    ...
                    {dataClaimable &&
                        ...
                        dataClaimable.project.tokenPriceChart && (
                            <Pressable onPress={enableViewChart}>
                                <AppText
                                    titleWithI18n={t(
                                        LanguageKey.claim_view_JETTON_price_chart,
                                        {
                                            symbol: dataClaimable?.projectToken
                                                ?.symbol,
                                        },
                                    )}
                                    variant={TextVariantKeys.bodyMLarge}
        ...
        <Pressable
            ...
            <LoadingWrapper
                ...
                <TouchableOpacity
                    ...
                    onPress={action}>
                    <View style={newUI ? styles.seeMoreNewUI : appStyles.mr5}>
                        <AppText
                    ...
                    style={[
                        styles.tabBarStyle,
                        {
                            borderBottomColor:
                                currentIndex === i
                                    ? appColors.main.tokyoRed
                                    : appStyles.backgroundTransparent
                                          .backgroundColor,
                        },
                    ]}>
                    <AppText
    ...
    return (
        <View style={[appStyles.mh25, appStyles.flex1]}>
            <View style={[appStyles.flexRow, appStyles.pB15]}>
                <View
                    style={[appStyles.center, appStyles.flex1, appStyles.pL15]}>
                    <AppText

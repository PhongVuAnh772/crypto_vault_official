        ...
        <ScreenWrapper
            ...
            dataGetOwned?.nfts?.length === 0 ? (
                <View style={styles.containerEmpty}>
                    ...
                    <AppText
                        titleWithI18n={
                            LanguageKey.claim_confirm_empty_NFT_title
                        }
                        textColor={
                            newUI
                                ? appColors.neutral.black
                    ...
                    <AppText
                        titleWithI18n={
                            LanguageKey.claim_confirm_empty_NFT_description
                        }
                        textColor={
                            newUI
                                ? appColors.neutral.black
                ...
                <>
                    <View style={styles.container}>
                        <View
                            style={[appStyles.flex1, styles.projectContainer]}>
                            <ProjectInformation
                                project_name={
                            ...
                            <View style={[appStyles.pT15]}>
                                <View
                                    ...
                                    <LoadingWrapper
                                        ...
                                        <AppText
                                            titleWithI18n={
                                                LanguageKey.project_details_claim_details
                                            }
                                ...
                                <View
                                    ...
                                    <AppButtonSVG
                                        titleWithI18n={
                                            loading
                                                ? ''
                                                : LanguageKey.common_text_confirm
                                        }

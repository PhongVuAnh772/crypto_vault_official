...
const PersonalInformation: React.FC<RootNavigationType> = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      <BottomSheetModalGorhom refModal={bottomSheetRefMenu} snapPoints={["17"]}>
        <View
          style={[appStyles.mh25, appStyles.mt12, styles.bottomSheetContent]}
        >
          <RezPointOptions
            icon={<TrashSvgIcon />}
      ...
      <AppModal
        ...
        childrenContent={
          <View>
            <AppText
              titleWithI18n={LanguageKey.rez_point_delete_my_account_sub_title}
      ...
      <AppModal
        titleWithI18n={LanguageKey.rez_point_delete_account}
        subTitleWithI18n={LanguageKey.rez_point_delete_account_sub_title}

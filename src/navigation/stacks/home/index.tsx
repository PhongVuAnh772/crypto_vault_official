        ...
        const unsubscribeOnNotificationOpenedApp =
            messaging().onNotificationOpenedApp(remoteMessage => {
                if (remoteMessage) {
                    ...
                    const key =
                        (remoteMessage?.data?.key as string) || undefined;
    ...
    return (
        <>
            <HideHeaderStack initialRouteName={HomeStackScreenKey.BottomTab}>
                ...
                />
                <Stack.Screen
                    name={HomeStackScreenKey.NFTList}
                    component={NFTList}
                />
                <Stack.Screen
                ...
                />
                <Stack.Screen
                    name={HomeStackScreenKey.NFTSend}
                    component={NFTSend}
                />
                <Stack.Screen
                ...
                />
                <Stack.Screen
                    name={HomeStackScreenKey.AboutUs}
                    component={AboutUs}
                />
                <Stack.Screen
                    name={HomeStackScreenKey.Contact}
                    component={Contact}
                />

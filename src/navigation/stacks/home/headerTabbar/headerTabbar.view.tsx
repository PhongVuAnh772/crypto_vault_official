            ...
            case MenuActionType.edit:
                return (
                    <EditModalView
                        ...
                        avtColor={
                            selectedWallet
                                ? selectedWallet.avtColor
                                : currentWallet?.avtColor
                        }
                    />
                );
            ...
            <View style={styles.container}>
                {titleI18N === LanguageKey.home_tab_crypto_title ? (
                    ...
                    <AppText
                        ...
                        styles={newUI ? appStyles.pB10 : undefined}
                        textColor={
                            newUI
                ...
                <View style={[appStyles.flexRow, styles.iconContainer]}>
                    {/* <TouchableOpacity
                        ...
                        // onPress={gotoNotificationListScreen}
                    >
                        {newUI ? (
                            <Notification2SvgIcon
                                color={
                                    theme.colors
                    ...
                    {titleI18N ===
                        LanguageKey.home_tab_nft_collection_title && (
                        <TouchableOpacity
                            onPress={handleOnPressImport}
                            style={styles.ml8}>
                            {newUI ? (
                                <AddFillNewSvgIcon width="32" height="32" />
                            ) : (
                                <AddFillSvgIcon
                                    fill={'red'}
                                    width="24"
                    ...
                    {titleI18N === LanguageKey.home_tab_explore_title && (
                        <View style={appStyles.flexRow}>
                            ...
                            <TouchableOpacity
                                onPress={() =>
                                    navigation.navigate(
                                        HomeStackScreenKey.ConnectionScreen,
                                    )
                                }>
                                <ConnectSvgIcon
                                    width="32"

    ...
    async (
        ...
        try {
            ...
            const finalProtocolData =
                AccountUtils.checkProtocolDataWithDefaultData(
                    checkSlip0044Data,
                );
            ...
            console.log(
                'getMobileProtocolListsWithSupportedTokens error',
                error,
            );
    ...
    async (
        ...
        try {
            ...
            if (!protocolListsWithSupportedTokensFromBE) {
                ...
                if (
                    getMobileProtocolListsWithSupportedTokens.fulfilled.match(
                        res,
                    )
                ) {
            ...
            const mnemonicExist = accountLists?.some(
                e => e.mnemonic === mnemonic,
            );
            ...
            if (currentAccount !== undefined) {
                ...
                if (
                    ...
                    const newProtocolData = [
                        ...(accountProtocolData ?? []),
                    ].filter(e => e._id !== currentAccountProtocolData._id);
...
export const accountSlice = createSlice({
    ...
    extraReducers: build => {
        build
            ...
            .addCase(
                getMobileProtocolListsWithSupportedTokens.pending,
                state => {
                    state.error = undefined;
                },
            )

...
class TonServices {
    ...
    sendMessageToBlockchain = async (
        body: SendMessageToBlockchainParamType,
    ) => {
    ...
    getNFTItemsInCollectionByOwner = async (
        ...
        try {
            ...
            if (
                ...
                Array.isArray(
                    (nftItemsInCollectionByOwner.data as NFTItemsOwner)
                        .nft_items,
                )
            ) {
                return (nftItemsInCollectionByOwner.data as NFTItemsOwner)
                    .nft_items;
            }
    ...
    getDetailJettonByAddress = async ({
        ...
        try {
            const response =
                await this._tonGetApi<DetailJettonByAddressResponse>({

...
import { FaceIdOrTouchCheckType, ResultErrorType } from './faceIdOrTouchType';
...
class FaceIdOrTouch {
    ...
    constructor(
        ...
        this.requestString = translation(
            LanguageKey.face_id_request_description,
            {
            ...
            Utils.showToast({
                msg: this.translation(LanguageKey.face_id_not_support, {
                    type: Utils.isAndroid
                        ...
                        : this.translation(
                              LanguageKey.common_text_face_id_and_touch,
                          ),
                }),

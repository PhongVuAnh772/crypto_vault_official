...
import {
  ...
  TonAccountsType,
  TonEventsDataType,
} from "../../../type/TonService";
import { sendGet } from "src/network/requests";
import { SendGetParamsType } from "src/network/requests/sendGet";
import sendPost, { SendPostParamsType } from "src/network/requests/sendPost";
import tonConnectConstants from "../constants/TonConnect";

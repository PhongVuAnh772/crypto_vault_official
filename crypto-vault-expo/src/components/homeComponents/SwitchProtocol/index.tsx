      ...
      footerView={
        <View style={[appStyles.pB20, appStyles.pH10]}>
          <Text style={appStyles.textAlignCenter}>
            ...
            />
            <AppText
              titleWithI18n={t(LanguageKey.claim_token_switch_protocol_1)}
              variant={TextVariantKeys.bodyRMedium}
              textColor={theme.colors.text_on_surface_text_high}
              styles={appStyles.textAlignCenter}
            />
            ...
            />
            <AppText
              titleWithI18n={LanguageKey.claim_token_switch_protocol_2}
              variant={TextVariantKeys.bodyRMedium}
              textColor={theme.colors.text_on_surface_text_high}
              styles={appStyles.textAlignCenter}
            />
          ...
          <Text style={[appStyles.textAlignCenter, appStyles.mt15]}>
            <AppText
              titleWithI18n={t(LanguageKey.claim_token_switch_protocol_3)}
              variant={TextVariantKeys.bodyRMedium}
              textColor={theme.colors.text_on_surface_text_high}
              styles={appStyles.textAlignCenter}
            />
            ...
            />
            <AppText
              titleWithI18n={t(LanguageKey.claim_token_switch_protocol_4)}
              variant={TextVariantKeys.bodyRMedium}
              textColor={theme.colors.text_on_surface_text_high}
              styles={appStyles.textAlignCenter}
            />

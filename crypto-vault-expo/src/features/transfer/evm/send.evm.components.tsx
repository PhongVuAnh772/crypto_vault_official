      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={[styles.pd25, styles.flex1]}>
          <TouchableOpacity
            ...
            onPress={onClose}
          >
            <Close2SvgIcon color={theme.colors.outline_outine_strong} />
          </TouchableOpacity>
          <AppText
          ...
          <View style={styles.mt15}>
            <AppText
              titleWithI18n={t(LanguageKey.send_request_permission_sub_title, {
                name: tokenName,
              })}
          ...
          <View style={styles.boxFee}>
            ...
            >
              <AppText
                titleWithI18n={LanguageKey.common_total_grant_amount}
    ...
    <View style={[styles.flex1, styles.mbt15]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={[styles.flex1, styles.pH25]}>
          ...
          <View style={[styles.mbt20, styles.alignItemsCenter, styles.mt15]}>
            <AppText
          ...
          <View style={styles.containerBox}>
            ...
            <View
              style={[styles.flexRow, styles.mt15, styles.alignItemsCenter]}
            >

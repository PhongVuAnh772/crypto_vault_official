      ...
      >
        <View style={styles.logoCollection}>
          {collection.collection_logo ? (
            ...
            <Avatar.Text
              size={24}
              label={collection.name ? collection.name.slice(0, 1) : "R"}
        ...
        <View style={[appStyles.flex1, appStyles.ph12]}>
          <AppText
            titleWithI18n={
              collection.name || t(LanguageKey.nft_unnamed_collection)
            }
          ...
          <View style={[appStyles.mv5, appStyles.flexRow]}>
            {collection.verified_collection ? (
              ...
              >
                ...
                />
                <AppText
                  titleWithI18n={LanguageKey.un_added_nfts_verified_collection}
            ...
            {collection.possible_spam && (
              ...
              >
                ...
                />
                <AppText
                  titleWithI18n={LanguageKey.un_added_nfts_unverified_spam}
                  styles={appStyles.ml5}
                  variant={TextVariantKeys.bodyMTiny}
                  textColor={appColors.neutral.white}
                  numberOfLines={1}

        ...
        <View style={addCustomTokenStyle.flex1}>
          <View style={addCustomTokenStyle.mt10}>
            <WalletAddressInput
              ...
              labelPlaceholderTitle={t(LanguageKey.nft_contract_address)}
          ...
          <View style={addCustomTokenStyle.mt15}>
            <AppTextInput
              ...
              required
              placeholder={t(LanguageKey.common_enter_symbol_token)}
              value={symbolToken}
          ...
          <View style={addCustomTokenStyle.mt15}>
            <AppTextInput
              ...
              required
              placeholder={t(LanguageKey.common_enter_decimals_token)}
              value={decimalsToken}

...
const NFTSend: React.FC<RootNavigationType> = (props) => {
  ...
  return (
    <>
      ...
      >
        <KeyboardAvoidingView behavior="padding" style={[NFTSendStyle.flex1]}>
          <View
            style={[
              NFTSendStyle.flex1,
              { backgroundColor: appColors.neutral.n100 },
          ...
          >
            {isLoadingSkeleton ? (
              <SendNFTSkeletonLoading isHasQuantity={isHasQuantity} />
            ) : (
              <View style={[NFTSendStyle.pT15, NFTSendStyle.flex1]}>
                <View style={[NFTSendStyle.flex1, NFTSendStyle.pH25]}>
                  <NFTInformation
                  ...
                  <View style={NFTSendStyle.mt10}>
                    <WalletAddressInput
                      ...
                      value={walletAddress}
                      showTo
                      containerStyle={[NFTSendStyle.WalletInput]}
                      labelStyle={NFTSendStyle.labelWalletAddress}
                      inputAddressContainer={NFTSendStyle.input}
                  ...
                  {isHasQuantity && (
                    <View style={NFTSendStyle.mt15}>
                      <AppTextInput
                        ...
                        required
                        labelName={t(LanguageKey.project_detail_quantity)}
                        styleTextInput={NFTSendStyle.inputQuantity}
                        placeholder={t(LanguageKey.enter_quantity)}

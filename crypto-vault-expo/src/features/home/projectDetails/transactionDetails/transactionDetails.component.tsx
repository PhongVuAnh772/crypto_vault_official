    ...
    <View style={styles.project}>
      ...
      {transactionHash ? (
        ...
        >
          ...
          >
            <View style={[appStyles.flexRow, appStyles.alignItemsCenter]}>
              <AppText
                title={WalletUtils.getShortMoreAddress(transactionHash)}
                variant={TextVariantKeys.bodyMLarge}
                textColor={theme.colors.text_on_surface_text_highest}
                numberOfLines={1}
                maxFontSizeMultiplier={1.2}
      ...
      {transactionHash && (
        ...
        >
          ...
          >
            <View
              style={[appStyles.flexRow, appStyles.flex1, appStyles.center]}
            >
              <AppText
              ...
              />
              <View style={appStyles.ml5}>{<ArrowForward2SvgIcon />}</View>
            </View>
          </TouchableOpacity>
        </LoadingWrapper>
      )}
  ...
  return (
    <View style={styles.projectDetails}>
      <FlatList
        ...
        data={dataGetOwned}
        renderItem={({ item }) =>
          renderNFTTransactionDetails(item, theme, dataClaimable, loading, true)
        }
        ListEmptyComponent={

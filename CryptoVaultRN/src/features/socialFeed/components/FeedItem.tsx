    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.moreBtn}>
          <MaterialCommunityIcons name="dots-horizontal" size={24} color="#8F9BB3" />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        <View style={styles.leftActions}>
          ...
          <TouchableOpacity style={styles.pillAction} onPress={() => {
            ...
            <MaterialCommunityIcons name="comment-outline" size={17} color="#8F9BB3" />
            <Text style={styles.pillText}>{formatNumber(item.comments)}</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.pillAction} onPress={handleShare}>
            <MaterialCommunityIcons name="repeat" size={19} color="#8F9BB3" />
        ...
        <TouchableOpacity style={styles.bookmarkBtn} onPress={handleBookmark}>
          <MaterialCommunityIcons 
            ...
            size={22} 
            color={isBookmarked ? "#9E86FF" : "#8F9BB3"} 
          />
        </TouchableOpacity>
      </View>
      ...
      {showCommentInput && !isDetail && (
        <View style={styles.commentInputContainer}>
          ...
          <TouchableOpacity onPress={handleCommentSubmit} disabled={!isLoggedIn}>
             <MaterialCommunityIcons name="send" size={22} color={commentText.trim() ? "#9E86FF" : "#8F9BB3"} />
          </TouchableOpacity>
        </View>
      )}
    </View>

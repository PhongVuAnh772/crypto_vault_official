...
import WalletCore
import CryptoKit
import WalletCoreModule



@objc(BitcoinModule)
public class BitcoinModule: NSObject {
  ...
  @objc public static func isValidBitcoinAddress(
    isTestNet: Bool,
    address: String,
  ...
  @objc public static func bitcoinGetMaxAmount(
    byteFee: Int64,
  ...
  @objc public static func bitcoinTransaction(
    env: String ,
    mnemonic: String,
    toAddress: String,
    amountSend: Int64,

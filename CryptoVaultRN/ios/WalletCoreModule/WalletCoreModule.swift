...
public class WalletCoreModule: NSObject {
  
  // MARK: Get Address With Env
  
  public static func getAddressWithEnv(env: String ,coinType: CoinType, derivation: Derivation? = Derivation.default, mnemonic: String) -> String? {
  ...
  @objc public static func getEVMKeyAndAddressFromSlip0044(mnemonic: String, slip0044: UInt32, derivationPath: String, successCallback: @escaping RCTResponseSenderBlock, failCallback: @escaping RCTResponseSenderBlock) {
  ...
  @objc public static func getDataFromSlip0044(
      mnemonic: String,
      isTestNet: Bool,
      slip0044: UInt32,
  ...
  public static func getKeyWithEnv(env: String ,coinType: CoinType, derivation: Derivation? = Derivation.default, mnemonic: String) -> PrivateKey? {
    if let wallet = HDWallet(mnemonic: mnemonic, passphrase: "") {
  ...
  @objc public static func createWallet(successCallback: RCTResponseSenderBlock, failCallback: RCTResponseSenderBlock) {
  ...
  @objc public static func importWallet(mnemonic: String, successCallback: @escaping RCTResponseSenderBlock, failCallback: @escaping RCTResponseSenderBlock) {
    if let wallet = HDWallet(mnemonic: mnemonic, passphrase: "") {

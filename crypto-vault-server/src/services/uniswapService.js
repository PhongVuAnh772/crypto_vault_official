...
const UNISWAP_ROUTER_ADDRESS = '0xC532a74256D3Db42D0FE72a79E0273a447475895';
...
class UniswapService {
  ...
  async getSwapTransactionData(userId, amountIn, tokenIn, tokenOut, slippage = 0.5) {
    try {
      const amountInWei = ethers.parseEther(amountIn.toString());
      ...
      const data = routerInterface.encodeFunctionData('swapExactETHForTokens', [
        amountOutMin,
        path,
        '0x0000000000000000000000000000000000000000', // Sẽ được thay bằng địa chỉ ví người dùng ở Frontend
        deadline
      ]);
